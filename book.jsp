...
%>
<h2 style="text-align:center;">Welcome <%=ss%>,Payment</h2>
<div class="d1">
...
%>
<form action="confirmbook.jsp">
Days:<input type="text" name="day" placeholder="Enter days" >
<%-- <input type="submit" value="Book"> --%>
<button type="submit" onclick="alert('Confirm Booking!')">Book</button>
</form>
<a type="button" href="home.jsp" class="b1">Back</a>
</div>
